package co.com.empresa.certification.proyectname.step_definitions;
...
public class TodoUserSteps {
    ...
    public void todo_list_should_contain(List<String> expectedItems) throws Throwable {
        theActorInTheSpotlight().should(GivenWhenThen.seeThat(TheItems.displayed(), equalTo(expectedItems)));
    }
